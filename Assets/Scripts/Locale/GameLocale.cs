...
public static class LocaleCatalog
{
    private static readonly Dictionary<string, (string ja, string en)> Map =
        new Dictionary<string, (string ja, string en)>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            { "search.card_name", ("カード名", "Card Name") },
            { "search.included", ("収録カード", "Included Cards") },
            { "search.set_search", ("作品検索", "Set Search") },
            ...
            { "search.filter.source", ("収録元", "Source") },
            { "search.filter.cost", ("コスト", "Cost") },
            { "search.filter.level", ("レベル", "Level") },
            ...
            { "mulligan.action", ("マリガン", "Mulligan") },
            { "mulligan.keep", ("キープ", "Keep") },
            { "mulligan.divider", ("マリガン", "Mulligan") },
            { "mulligan.first", ("先攻", "First") },
            { "mulligan.second", ("後攻", "Second") },
            { "mulligan.kept", ("キープ済", "Kept") },
